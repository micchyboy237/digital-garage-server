...
const Schema: z.ZodType<Prisma.VehiclePostUncheckedUpdateManyWithoutOwnershipNestedInput> = z
  .object({
    create: z
      .union([
...
export const VehiclePostUncheckedUpdateManyWithoutOwnershipNestedInputObjectSchema = Schema
