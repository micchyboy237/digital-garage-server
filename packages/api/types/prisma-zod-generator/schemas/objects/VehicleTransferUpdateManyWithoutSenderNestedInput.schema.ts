...
const Schema: z.ZodType<Prisma.VehicleTransferUpdateManyWithoutSenderNestedInput> = z
  .object({
    create: z
      .union([
...
export const VehicleTransferUpdateManyWithoutSenderNestedInputObjectSchema = Schema
