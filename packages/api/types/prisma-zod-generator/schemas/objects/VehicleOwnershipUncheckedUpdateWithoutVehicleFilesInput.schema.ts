...
const Schema: z.ZodType<Prisma.VehicleOwnershipUncheckedUpdateWithoutVehicleFilesInput> = z
  .object({
...
export const VehicleOwnershipUncheckedUpdateWithoutVehicleFilesInputObjectSchema = Schema
