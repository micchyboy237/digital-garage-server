...
const Schema: z.ZodType<Prisma.MediaFileUncheckedUpdateManyWithoutPostNestedInput> = z
  .object({
    create: z
      .union([
...
export const MediaFileUncheckedUpdateManyWithoutPostNestedInputObjectSchema = Schema
