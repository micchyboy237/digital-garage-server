...
const Schema: z.ZodType<Prisma.VehicleOwnershipCreateNestedManyWithoutUserInput> = z
  .object({
    create: z
      .union([
...
export const VehicleOwnershipCreateNestedManyWithoutUserInputObjectSchema = Schema
