...
const Schema: z.ZodType<Prisma.VehiclePostUncheckedCreateNestedManyWithoutOwnershipInput> = z
  .object({
    create: z
      .union([
...
export const VehiclePostUncheckedCreateNestedManyWithoutOwnershipInputObjectSchema = Schema
