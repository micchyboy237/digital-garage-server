...
const Schema: z.ZodType<Prisma.UserCreateNestedOneWithoutDisplayPictureInput> = z
  .object({
    create: z
      .union([
...
export const UserCreateNestedOneWithoutDisplayPictureInputObjectSchema = Schema
