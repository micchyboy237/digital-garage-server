...
const Schema: z.ZodType<Prisma.SubscriptionUpdateOneWithoutUserNestedInput> = z
  .object({
    create: z
      .union([
...
export const SubscriptionUpdateOneWithoutUserNestedInputObjectSchema = Schema
