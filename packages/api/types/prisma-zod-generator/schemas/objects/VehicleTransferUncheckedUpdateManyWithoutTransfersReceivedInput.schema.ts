...
const Schema: z.ZodType<Prisma.VehicleTransferUncheckedUpdateManyWithoutTransfersReceivedInput> = z
  .object({
...
export const VehicleTransferUncheckedUpdateManyWithoutTransfersReceivedInputObjectSchema = Schema
