...
const Schema: z.ZodType<Prisma.VehicleTransferCreateNestedManyWithoutVehicleInput> = z
  .object({
    create: z
      .union([
...
export const VehicleTransferCreateNestedManyWithoutVehicleInputObjectSchema = Schema
