...
const Schema: z.ZodType<Prisma.SessionUpdateManyWithWhereWithoutAccountInput> = z
  .object({
...
export const SessionUpdateManyWithWhereWithoutAccountInputObjectSchema = Schema
