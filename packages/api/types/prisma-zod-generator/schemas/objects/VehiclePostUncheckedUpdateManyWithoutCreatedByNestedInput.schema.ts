...
const Schema: z.ZodType<Prisma.VehiclePostUncheckedUpdateManyWithoutCreatedByNestedInput> = z
  .object({
    create: z
      .union([
...
export const VehiclePostUncheckedUpdateManyWithoutCreatedByNestedInputObjectSchema = Schema
