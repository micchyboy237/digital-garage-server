...
const Schema: z.ZodType<Prisma.VehicleTransferUpdateManyWithoutRecipientNestedInput> = z
  .object({
    create: z
      .union([
...
export const VehicleTransferUpdateManyWithoutRecipientNestedInputObjectSchema = Schema
