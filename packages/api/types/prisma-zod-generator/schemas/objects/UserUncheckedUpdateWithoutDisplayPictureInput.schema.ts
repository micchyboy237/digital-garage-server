...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutDisplayPictureInput> = z
  .object({
...
export const UserUncheckedUpdateWithoutDisplayPictureInputObjectSchema = Schema
