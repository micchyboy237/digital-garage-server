...
const Schema: z.ZodType<Prisma.UserUpdateOneWithoutVehicleOwnershipsNestedInput> = z
  .object({
    create: z
      .union([
...
export const UserUpdateOneWithoutVehicleOwnershipsNestedInputObjectSchema = Schema
