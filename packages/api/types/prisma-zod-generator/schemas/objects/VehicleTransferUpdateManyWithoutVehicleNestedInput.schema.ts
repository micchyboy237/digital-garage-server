...
const Schema: z.ZodType<Prisma.VehicleTransferUpdateManyWithoutVehicleNestedInput> = z
  .object({
    create: z
      .union([
...
export const VehicleTransferUpdateManyWithoutVehicleNestedInputObjectSchema = Schema
