...
const Schema: z.ZodType<Prisma.VehicleOwnershipUpdateManyWithoutVehicleNestedInput> = z
  .object({
    create: z
      .union([
...
export const VehicleOwnershipUpdateManyWithoutVehicleNestedInputObjectSchema = Schema
