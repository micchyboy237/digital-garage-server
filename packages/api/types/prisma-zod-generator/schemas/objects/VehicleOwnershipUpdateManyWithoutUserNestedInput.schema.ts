...
const Schema: z.ZodType<Prisma.VehicleOwnershipUpdateManyWithoutUserNestedInput> = z
  .object({
    create: z
      .union([
...
export const VehicleOwnershipUpdateManyWithoutUserNestedInputObjectSchema = Schema
