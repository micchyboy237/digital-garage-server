...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutTransfersSentInput> = z
  .object({
...
export const UserUncheckedUpdateWithoutTransfersSentInputObjectSchema = Schema
