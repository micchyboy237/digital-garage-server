...
const Schema: z.ZodType<Prisma.VehicleUncheckedUpdateManyWithoutOwnerNestedInput> = z
  .object({
    create: z
      .union([
...
export const VehicleUncheckedUpdateManyWithoutOwnerNestedInputObjectSchema = Schema
