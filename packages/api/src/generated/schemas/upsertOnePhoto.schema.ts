...
export const PhotoUpsertSchema = z.object({
  ...
  create: z.union([PhotoCreateInputObjectSchema, PhotoUncheckedCreateInputObjectSchema]),
  update: z.union([PhotoUpdateInputObjectSchema, PhotoUncheckedUpdateInputObjectSchema]),
})
