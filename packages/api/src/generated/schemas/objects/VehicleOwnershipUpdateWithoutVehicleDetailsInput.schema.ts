...
const Schema: z.ZodType<Prisma.VehicleOwnershipUpdateWithoutVehicleDetailsInput> = z
  .object({
...
export const VehicleOwnershipUpdateWithoutVehicleDetailsInputObjectSchema = Schema
