...
const Schema: z.ZodType<Prisma.VehicleEventUpdateManyWithWhereWithoutVehicleOwnershipInput> = z
  .object({
...
export const VehicleEventUpdateManyWithWhereWithoutVehicleOwnershipInputObjectSchema = Schema
