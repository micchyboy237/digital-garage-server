...
const Schema: z.ZodType<Prisma.VehicleOwnershipUpdateWithoutDisplayPictureInput> = z
  .object({
...
export const VehicleOwnershipUpdateWithoutDisplayPictureInputObjectSchema = Schema
