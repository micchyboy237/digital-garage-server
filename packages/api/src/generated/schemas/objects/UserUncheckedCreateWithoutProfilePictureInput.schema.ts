...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutProfilePictureInput> = z
  .object({
...
export const UserUncheckedCreateWithoutProfilePictureInputObjectSchema = Schema
