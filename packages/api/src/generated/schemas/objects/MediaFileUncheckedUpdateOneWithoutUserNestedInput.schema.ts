...
const Schema: z.ZodType<Prisma.MediaFileUncheckedUpdateOneWithoutUserNestedInput> = z
  .object({
    create: z
      .union([
...
export const MediaFileUncheckedUpdateOneWithoutUserNestedInputObjectSchema = Schema
