...
const Schema: z.ZodType<Prisma.VehicleDocumentUncheckedUpdateManyWithoutOwnershipNestedInput> = z
  .object({
    create: z
      .union([
...
export const VehicleDocumentUncheckedUpdateManyWithoutOwnershipNestedInputObjectSchema = Schema
