...
import { PhotoUncheckedUpdateManyWithoutPostNestedInputObjectSchema } from "./PhotoUncheckedUpdateManyWithoutPostNestedInput.schema"
...
const Schema: z.ZodType<Prisma.VehiclePostUncheckedUpdateWithoutOwnershipInput> = z
  .object({
    ...
    photos: z.lazy(() => PhotoUncheckedUpdateManyWithoutPostNestedInputObjectSchema).optional(),
    documents: z.lazy(() => VehicleDocumentUncheckedUpdateManyWithoutPostNestedInputObjectSchema).optional(),
  })
  .strict()

export const VehiclePostUncheckedUpdateWithoutOwnershipInputObjectSchema = Schema
