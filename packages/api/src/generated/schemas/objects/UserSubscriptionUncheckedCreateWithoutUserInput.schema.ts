...
const Schema: z.ZodType<Prisma.UserSubscriptionUncheckedCreateWithoutUserInput> = z
  .object({
...
export const UserSubscriptionUncheckedCreateWithoutUserInputObjectSchema = Schema
