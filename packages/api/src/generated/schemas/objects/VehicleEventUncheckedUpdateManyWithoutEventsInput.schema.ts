...
const Schema: z.ZodType<Prisma.VehicleEventUncheckedUpdateManyWithoutEventsInput> = z
  .object({
...
export const VehicleEventUncheckedUpdateManyWithoutEventsInputObjectSchema = Schema
