...
const Schema: z.ZodType<Prisma.MediaFileUncheckedCreateNestedOneWithoutUserInput> = z
  .object({
    create: z
      .union([
...
export const MediaFileUncheckedCreateNestedOneWithoutUserInputObjectSchema = Schema
