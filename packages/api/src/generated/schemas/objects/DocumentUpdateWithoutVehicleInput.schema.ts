...
import { VehicleEventUpdateOneWithoutDocumentsNestedInputObjectSchema } from "./VehicleEventUpdateOneWithoutDocumentsNestedInput.schema"
...
const Schema: z.ZodType<Prisma.DocumentUpdateWithoutVehicleInput> = z
  .object({
    ...
    vehicleEvent: z.lazy(() => VehicleEventUpdateOneWithoutDocumentsNestedInputObjectSchema).optional(),
  })
  .strict()
