...
const Schema: z.ZodType<Prisma.DocumentUncheckedUpdateWithoutVehicleEventInput> = z
  .object({
...
export const DocumentUncheckedUpdateWithoutVehicleEventInputObjectSchema = Schema
