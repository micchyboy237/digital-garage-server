...
const Schema: z.ZodType<Prisma.VehicleDocumentUncheckedUpdateManyWithoutPostNestedInput> = z
  .object({
    create: z
      .union([
...
export const VehicleDocumentUncheckedUpdateManyWithoutPostNestedInputObjectSchema = Schema
