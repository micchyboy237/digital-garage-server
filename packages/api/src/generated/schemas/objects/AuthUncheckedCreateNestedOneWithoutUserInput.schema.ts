...
const Schema: z.ZodType<Prisma.AuthUncheckedCreateNestedOneWithoutUserInput> = z
  .object({
    create: z
      .union([
...
export const AuthUncheckedCreateNestedOneWithoutUserInputObjectSchema = Schema
