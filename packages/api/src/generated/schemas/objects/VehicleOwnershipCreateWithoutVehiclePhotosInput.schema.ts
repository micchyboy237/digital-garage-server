...
const Schema: z.ZodType<Prisma.VehicleOwnershipCreateWithoutVehiclePhotosInput> = z
  .object({
...
export const VehicleOwnershipCreateWithoutVehiclePhotosInputObjectSchema = Schema
