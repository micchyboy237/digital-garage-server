...
const Schema: z.ZodType<Prisma.UserSubscriptionUncheckedUpdateWithoutSubscriptionInput> = z
  .object({
...
export const UserSubscriptionUncheckedUpdateWithoutSubscriptionInputObjectSchema = Schema
