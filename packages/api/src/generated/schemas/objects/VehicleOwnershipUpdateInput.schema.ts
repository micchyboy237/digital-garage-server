...
import { UserUpdateOneRequiredWithoutVehiclesNestedInputObjectSchema } from "./UserUpdateOneRequiredWithoutVehiclesNestedInput.schema"
...
const Schema: z.ZodType<Prisma.VehicleOwnershipUpdateInput> = z
  .object({
    ...
    user: z.lazy(() => UserUpdateOneRequiredWithoutVehiclesNestedInputObjectSchema).optional(),
    vehicle: z.lazy(() => VehicleUpdateOneRequiredWithoutOwnershipHistoryNestedInputObjectSchema).optional(),
  })
  .strict()

export const VehicleOwnershipUpdateInputObjectSchema = Schema
