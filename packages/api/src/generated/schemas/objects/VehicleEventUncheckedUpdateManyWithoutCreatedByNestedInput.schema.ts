...
const Schema: z.ZodType<Prisma.VehicleEventUncheckedUpdateManyWithoutCreatedByNestedInput> = z
  .object({
    create: z
      .union([
...
export const VehicleEventUncheckedUpdateManyWithoutCreatedByNestedInputObjectSchema = Schema
