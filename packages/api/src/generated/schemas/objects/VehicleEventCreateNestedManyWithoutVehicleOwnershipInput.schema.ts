...
const Schema: z.ZodType<Prisma.VehicleEventCreateNestedManyWithoutVehicleOwnershipInput> = z
  .object({
    create: z
      .union([
...
export const VehicleEventCreateNestedManyWithoutVehicleOwnershipInputObjectSchema = Schema
