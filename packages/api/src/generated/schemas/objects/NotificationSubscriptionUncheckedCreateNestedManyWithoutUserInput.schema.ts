...
const Schema: z.ZodType<Prisma.NotificationSubscriptionUncheckedCreateNestedManyWithoutUserInput> = z
  .object({
    create: z
      .union([
...
export const NotificationSubscriptionUncheckedCreateNestedManyWithoutUserInputObjectSchema = Schema
