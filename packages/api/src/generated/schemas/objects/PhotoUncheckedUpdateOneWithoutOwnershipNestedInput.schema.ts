...
const Schema: z.ZodType<Prisma.PhotoUncheckedUpdateOneWithoutOwnershipNestedInput> = z
  .object({
    create: z
      .union([
...
export const PhotoUncheckedUpdateOneWithoutOwnershipNestedInputObjectSchema = Schema
