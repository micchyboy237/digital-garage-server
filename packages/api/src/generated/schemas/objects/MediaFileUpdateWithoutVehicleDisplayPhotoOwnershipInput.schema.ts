...
const Schema: z.ZodType<Prisma.MediaFileUpdateWithoutVehicleDisplayPhotoOwnershipInput> = z
  .object({
...
export const MediaFileUpdateWithoutVehicleDisplayPhotoOwnershipInputObjectSchema = Schema
