...
const Schema: z.ZodType<Prisma.VehicleUncheckedCreateNestedOneWithoutDetailsInput> = z
  .object({
    create: z
      .union([
...
export const VehicleUncheckedCreateNestedOneWithoutDetailsInputObjectSchema = Schema
