...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutNotificationSubsInput> = z
  .object({
    ...
    vehicles: z.lazy(() => VehicleOwnershipUncheckedUpdateManyWithoutUserNestedInputObjectSchema).optional(),
...
export const UserUncheckedUpdateWithoutNotificationSubsInputObjectSchema = Schema
