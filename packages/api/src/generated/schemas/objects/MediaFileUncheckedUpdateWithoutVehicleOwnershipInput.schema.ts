...
const Schema: z.ZodType<Prisma.MediaFileUncheckedUpdateWithoutVehicleOwnershipInput> = z
  .object({
...
export const MediaFileUncheckedUpdateWithoutVehicleOwnershipInputObjectSchema = Schema
