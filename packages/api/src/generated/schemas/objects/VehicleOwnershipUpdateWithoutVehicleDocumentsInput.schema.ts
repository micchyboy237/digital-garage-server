...
const Schema: z.ZodType<Prisma.VehicleOwnershipUpdateWithoutVehicleDocumentsInput> = z
  .object({
...
export const VehicleOwnershipUpdateWithoutVehicleDocumentsInputObjectSchema = Schema
