...
const Schema: z.ZodType<Prisma.PaymentUpdateManyWithWhereWithoutUserSubscriptionInput> = z
  .object({
...
export const PaymentUpdateManyWithWhereWithoutUserSubscriptionInputObjectSchema = Schema
