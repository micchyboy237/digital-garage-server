...
const Schema: z.ZodType<Prisma.VehicleOwnershipUncheckedCreateWithoutVehicleDocumentsInput> = z
  .object({
...
export const VehicleOwnershipUncheckedCreateWithoutVehicleDocumentsInputObjectSchema = Schema
