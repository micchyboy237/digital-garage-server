...
const Schema: z.ZodType<Prisma.VehicleOwnershipUncheckedUpdateWithoutVehiclePhotosInput> = z
  .object({
...
export const VehicleOwnershipUncheckedUpdateWithoutVehiclePhotosInputObjectSchema = Schema
