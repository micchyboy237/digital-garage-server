...
const Schema: z.ZodType<Prisma.MediaFileUncheckedUpdateManyWithoutFilesInput> = z
  .object({
...
export const MediaFileUncheckedUpdateManyWithoutFilesInputObjectSchema = Schema
