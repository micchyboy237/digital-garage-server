...
const Schema: z.ZodType<Prisma.VehicleOwnershipUncheckedUpdateWithoutEventsInput> = z
  .object({
...
export const VehicleOwnershipUncheckedUpdateWithoutEventsInputObjectSchema = Schema
