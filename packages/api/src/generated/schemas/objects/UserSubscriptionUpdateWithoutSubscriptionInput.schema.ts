...
import { UserUpdateOneRequiredWithoutSubscriptionNestedInputObjectSchema } from "./UserUpdateOneRequiredWithoutSubscriptionNestedInput.schema"
...
const Schema: z.ZodType<Prisma.UserSubscriptionUpdateWithoutSubscriptionInput> = z
  .object({
    ...
    user: z.lazy(() => UserUpdateOneRequiredWithoutSubscriptionNestedInputObjectSchema).optional(),
    payments: z.lazy(() => PaymentUpdateManyWithoutUserSubscriptionNestedInputObjectSchema).optional(),
  })
  .strict()

export const UserSubscriptionUpdateWithoutSubscriptionInputObjectSchema = Schema
