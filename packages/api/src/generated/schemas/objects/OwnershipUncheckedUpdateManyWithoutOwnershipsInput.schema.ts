...
const Schema: z.ZodType<Prisma.OwnershipUncheckedUpdateManyWithoutOwnershipsInput> = z
  .object({
...
export const OwnershipUncheckedUpdateManyWithoutOwnershipsInputObjectSchema = Schema
