...
const Schema: z.ZodType<Prisma.DocumentUpdateManyWithWhereWithoutCreatedByInput> = z
  .object({
...
export const DocumentUpdateManyWithWhereWithoutCreatedByInputObjectSchema = Schema
