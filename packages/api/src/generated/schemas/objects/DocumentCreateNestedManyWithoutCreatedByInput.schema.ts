...
const Schema: z.ZodType<Prisma.DocumentCreateNestedManyWithoutCreatedByInput> = z
  .object({
    create: z
      .union([
...
export const DocumentCreateNestedManyWithoutCreatedByInputObjectSchema = Schema
