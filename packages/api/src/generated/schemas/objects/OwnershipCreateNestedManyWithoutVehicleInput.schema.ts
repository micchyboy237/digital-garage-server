...
const Schema: z.ZodType<Prisma.OwnershipCreateNestedManyWithoutVehicleInput> = z
  .object({
    create: z
      .union([
...
export const OwnershipCreateNestedManyWithoutVehicleInputObjectSchema = Schema
