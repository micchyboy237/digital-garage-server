...
const Schema: z.ZodType<Prisma.PaymentUncheckedUpdateManyWithoutPaymentsInput> = z
  .object({
...
export const PaymentUncheckedUpdateManyWithoutPaymentsInputObjectSchema = Schema
