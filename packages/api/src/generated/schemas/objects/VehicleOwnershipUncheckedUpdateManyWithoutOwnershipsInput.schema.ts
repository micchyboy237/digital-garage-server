...
const Schema: z.ZodType<Prisma.VehicleOwnershipUncheckedUpdateManyWithoutOwnershipsInput> = z
  .object({
...
export const VehicleOwnershipUncheckedUpdateManyWithoutOwnershipsInputObjectSchema = Schema
