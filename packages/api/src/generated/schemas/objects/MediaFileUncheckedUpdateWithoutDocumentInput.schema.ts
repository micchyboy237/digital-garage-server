...
const Schema: z.ZodType<Prisma.MediaFileUncheckedUpdateWithoutDocumentInput> = z
  .object({
...
export const MediaFileUncheckedUpdateWithoutDocumentInputObjectSchema = Schema
