...
const Schema: z.ZodType<Prisma.VehicleDocumentUpdateOneWithoutFileNestedInput> = z
  .object({
    create: z
      .union([
...
export const VehicleDocumentUpdateOneWithoutFileNestedInputObjectSchema = Schema
