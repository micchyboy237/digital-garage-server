...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutDocumentsInput> = z
  .object({
    ...
    vehicles: z.lazy(() => VehicleOwnershipUncheckedCreateNestedManyWithoutUserInputObjectSchema).optional(),
...
export const UserUncheckedCreateWithoutDocumentsInputObjectSchema = Schema
