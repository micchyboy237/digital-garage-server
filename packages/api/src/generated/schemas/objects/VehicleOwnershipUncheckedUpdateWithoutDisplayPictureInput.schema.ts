...
const Schema: z.ZodType<Prisma.VehicleOwnershipUncheckedUpdateWithoutDisplayPictureInput> = z
  .object({
...
export const VehicleOwnershipUncheckedUpdateWithoutDisplayPictureInputObjectSchema = Schema
