...
const Schema: z.ZodType<Prisma.DocumentUpdateManyWithoutVehicleNestedInput> = z
  .object({
    create: z
      .union([
...
export const DocumentUpdateManyWithoutVehicleNestedInputObjectSchema = Schema
