...
const Schema: z.ZodType<Prisma.PaymentCreateNestedManyWithoutUserSubscriptionInput> = z
  .object({
    create: z
      .union([
...
export const PaymentCreateNestedManyWithoutUserSubscriptionInputObjectSchema = Schema
