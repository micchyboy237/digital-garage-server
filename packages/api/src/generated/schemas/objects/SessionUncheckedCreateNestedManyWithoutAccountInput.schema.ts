...
const Schema: z.ZodType<Prisma.SessionUncheckedCreateNestedManyWithoutAccountInput> = z
  .object({
    create: z
      .union([
...
export const SessionUncheckedCreateNestedManyWithoutAccountInputObjectSchema = Schema
