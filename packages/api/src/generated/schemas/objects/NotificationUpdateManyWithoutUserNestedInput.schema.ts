...
const Schema: z.ZodType<Prisma.NotificationUpdateManyWithoutUserNestedInput> = z
  .object({
    create: z
      .union([
...
export const NotificationUpdateManyWithoutUserNestedInputObjectSchema = Schema
