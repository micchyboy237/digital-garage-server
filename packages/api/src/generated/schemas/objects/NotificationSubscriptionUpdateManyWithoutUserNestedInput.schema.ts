...
const Schema: z.ZodType<Prisma.NotificationSubscriptionUpdateManyWithoutUserNestedInput> = z
  .object({
    create: z
      .union([
...
export const NotificationSubscriptionUpdateManyWithoutUserNestedInputObjectSchema = Schema
