...
const Schema: z.ZodType<Prisma.VehicleEventCreateNestedManyWithoutVehicleInput> = z
  .object({
    create: z
      .union([
...
export const VehicleEventCreateNestedManyWithoutVehicleInputObjectSchema = Schema
