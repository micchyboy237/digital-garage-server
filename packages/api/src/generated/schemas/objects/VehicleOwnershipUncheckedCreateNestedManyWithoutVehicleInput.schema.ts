...
const Schema: z.ZodType<Prisma.VehicleOwnershipUncheckedCreateNestedManyWithoutVehicleInput> = z
  .object({
    create: z
      .union([
...
export const VehicleOwnershipUncheckedCreateNestedManyWithoutVehicleInputObjectSchema = Schema
