...
const Schema: z.ZodType<Prisma.VehicleEventUncheckedUpdateManyWithoutVehicleOwnershipNestedInput> = z
  .object({
    create: z
      .union([
...
export const VehicleEventUncheckedUpdateManyWithoutVehicleOwnershipNestedInputObjectSchema = Schema
