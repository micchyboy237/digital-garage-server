...
const Schema: z.ZodType<Prisma.VehicleOwnershipUncheckedUpdateManyWithoutVehiclesInput> = z
  .object({
...
export const VehicleOwnershipUncheckedUpdateManyWithoutVehiclesInputObjectSchema = Schema
