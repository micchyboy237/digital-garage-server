...
const Schema: z.ZodType<Prisma.VehicleEventUpdateManyWithoutVehicleNestedInput> = z
  .object({
    create: z
      .union([
...
export const VehicleEventUpdateManyWithoutVehicleNestedInputObjectSchema = Schema
