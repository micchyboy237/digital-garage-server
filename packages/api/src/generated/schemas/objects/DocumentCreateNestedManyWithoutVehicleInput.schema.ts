...
const Schema: z.ZodType<Prisma.DocumentCreateNestedManyWithoutVehicleInput> = z
  .object({
    create: z
      .union([
...
export const DocumentCreateNestedManyWithoutVehicleInputObjectSchema = Schema
