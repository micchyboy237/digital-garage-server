...
const Schema: z.ZodType<Prisma.MediaFileCreateNestedManyWithoutDocumentInput> = z
  .object({
    create: z
      .union([
...
export const MediaFileCreateNestedManyWithoutDocumentInputObjectSchema = Schema
