...
const Schema: z.ZodType<Prisma.DocumentUncheckedUpdateWithoutCreatedByInput> = z
  .object({
...
export const DocumentUncheckedUpdateWithoutCreatedByInputObjectSchema = Schema
