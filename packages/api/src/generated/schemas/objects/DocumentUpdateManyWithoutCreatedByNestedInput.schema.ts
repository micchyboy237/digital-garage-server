...
const Schema: z.ZodType<Prisma.DocumentUpdateManyWithoutCreatedByNestedInput> = z
  .object({
    create: z
      .union([
...
export const DocumentUpdateManyWithoutCreatedByNestedInputObjectSchema = Schema
