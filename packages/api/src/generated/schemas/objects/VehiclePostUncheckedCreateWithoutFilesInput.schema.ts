...
const Schema: z.ZodType<Prisma.VehiclePostUncheckedCreateWithoutFilesInput> = z
  .object({
...
export const VehiclePostUncheckedCreateWithoutFilesInputObjectSchema = Schema
