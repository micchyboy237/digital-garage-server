...
const Schema: z.ZodType<Prisma.UserSubscriptionUpdateManyWithoutSubscriptionNestedInput> = z
  .object({
    create: z
      .union([
...
export const UserSubscriptionUpdateManyWithoutSubscriptionNestedInputObjectSchema = Schema
