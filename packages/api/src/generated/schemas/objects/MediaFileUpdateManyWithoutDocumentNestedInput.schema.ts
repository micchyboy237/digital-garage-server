...
const Schema: z.ZodType<Prisma.MediaFileUpdateManyWithoutDocumentNestedInput> = z
  .object({
    create: z
      .union([
...
export const MediaFileUpdateManyWithoutDocumentNestedInputObjectSchema = Schema
