...
const Schema: z.ZodType<Prisma.VehicleOwnershipUncheckedUpdateManyWithoutOwnershipHistoryInput> = z
  .object({
...
export const VehicleOwnershipUncheckedUpdateManyWithoutOwnershipHistoryInputObjectSchema = Schema
