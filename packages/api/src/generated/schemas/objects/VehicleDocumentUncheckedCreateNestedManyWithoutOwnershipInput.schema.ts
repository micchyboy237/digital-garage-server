...
const Schema: z.ZodType<Prisma.VehicleDocumentUncheckedCreateNestedManyWithoutOwnershipInput> = z
  .object({
    create: z
      .union([
...
export const VehicleDocumentUncheckedCreateNestedManyWithoutOwnershipInputObjectSchema = Schema
