...
const Schema: z.ZodType<Prisma.VehicleOwnershipUpdateWithoutVehiclePhotosInput> = z
  .object({
...
export const VehicleOwnershipUpdateWithoutVehiclePhotosInputObjectSchema = Schema
