...
const Schema: z.ZodType<Prisma.VehicleDetailsCreateNestedOneWithoutOwnershipInput> = z
  .object({
    create: z
      .union([
...
export const VehicleDetailsCreateNestedOneWithoutOwnershipInputObjectSchema = Schema
