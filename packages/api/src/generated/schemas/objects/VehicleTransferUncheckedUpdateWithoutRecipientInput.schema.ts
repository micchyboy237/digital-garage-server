...
const Schema: z.ZodType<Prisma.VehicleTransferUncheckedUpdateWithoutRecipientInput> = z
  .object({
...
export const VehicleTransferUncheckedUpdateWithoutRecipientInputObjectSchema = Schema
