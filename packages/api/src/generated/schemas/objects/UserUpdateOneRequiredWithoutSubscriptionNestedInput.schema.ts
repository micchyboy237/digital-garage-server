...
const Schema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutSubscriptionNestedInput> = z
  .object({
    create: z
      .union([
...
export const UserUpdateOneRequiredWithoutSubscriptionNestedInputObjectSchema = Schema
