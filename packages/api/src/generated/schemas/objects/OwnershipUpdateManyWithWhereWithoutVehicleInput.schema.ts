...
const Schema: z.ZodType<Prisma.OwnershipUpdateManyWithWhereWithoutVehicleInput> = z
  .object({
...
export const OwnershipUpdateManyWithWhereWithoutVehicleInputObjectSchema = Schema
