...
const Schema: z.ZodType<Prisma.UserSubscriptionCreateNestedManyWithoutSubscriptionInput> = z
  .object({
    create: z
      .union([
...
export const UserSubscriptionCreateNestedManyWithoutSubscriptionInputObjectSchema = Schema
