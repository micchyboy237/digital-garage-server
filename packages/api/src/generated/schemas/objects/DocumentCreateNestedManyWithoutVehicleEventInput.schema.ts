...
const Schema: z.ZodType<Prisma.DocumentCreateNestedManyWithoutVehicleEventInput> = z
  .object({
    create: z
      .union([
...
export const DocumentCreateNestedManyWithoutVehicleEventInputObjectSchema = Schema
