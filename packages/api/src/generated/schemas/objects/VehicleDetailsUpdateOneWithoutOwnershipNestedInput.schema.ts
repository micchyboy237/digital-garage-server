...
const Schema: z.ZodType<Prisma.VehicleDetailsUpdateOneWithoutOwnershipNestedInput> = z
  .object({
    create: z
      .union([
...
export const VehicleDetailsUpdateOneWithoutOwnershipNestedInputObjectSchema = Schema
