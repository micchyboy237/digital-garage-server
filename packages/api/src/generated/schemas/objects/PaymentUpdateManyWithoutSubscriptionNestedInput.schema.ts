...
const Schema: z.ZodType<Prisma.PaymentUpdateManyWithoutSubscriptionNestedInput> = z
  .object({
    create: z
      .union([
...
export const PaymentUpdateManyWithoutSubscriptionNestedInputObjectSchema = Schema
