...
const Schema: z.ZodType<Prisma.VehicleEventUpdateWithoutVehicleOwnershipInput> = z
  .object({
...
export const VehicleEventUpdateWithoutVehicleOwnershipInputObjectSchema = Schema
