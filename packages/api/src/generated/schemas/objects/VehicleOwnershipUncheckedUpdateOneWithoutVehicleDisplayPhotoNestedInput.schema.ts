...
const Schema: z.ZodType<Prisma.VehicleOwnershipUncheckedUpdateOneWithoutVehicleDisplayPhotoNestedInput> = z
  .object({
    create: z
      .union([
...
export const VehicleOwnershipUncheckedUpdateOneWithoutVehicleDisplayPhotoNestedInputObjectSchema = Schema
