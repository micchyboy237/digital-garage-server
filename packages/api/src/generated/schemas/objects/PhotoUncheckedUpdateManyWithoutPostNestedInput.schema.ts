...
const Schema: z.ZodType<Prisma.PhotoUncheckedUpdateManyWithoutPostNestedInput> = z
  .object({
    create: z
      .union([
...
export const PhotoUncheckedUpdateManyWithoutPostNestedInputObjectSchema = Schema
