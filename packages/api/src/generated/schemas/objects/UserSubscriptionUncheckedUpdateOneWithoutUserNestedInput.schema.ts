...
const Schema: z.ZodType<Prisma.UserSubscriptionUncheckedUpdateOneWithoutUserNestedInput> = z
  .object({
    create: z
      .union([
...
export const UserSubscriptionUncheckedUpdateOneWithoutUserNestedInputObjectSchema = Schema
