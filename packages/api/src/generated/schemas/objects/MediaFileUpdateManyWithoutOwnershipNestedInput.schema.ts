...
const Schema: z.ZodType<Prisma.MediaFileUpdateManyWithoutOwnershipNestedInput> = z
  .object({
    create: z
      .union([
...
export const MediaFileUpdateManyWithoutOwnershipNestedInputObjectSchema = Schema
