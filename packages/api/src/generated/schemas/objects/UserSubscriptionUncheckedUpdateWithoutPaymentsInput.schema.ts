...
const Schema: z.ZodType<Prisma.UserSubscriptionUncheckedUpdateWithoutPaymentsInput> = z
  .object({
...
export const UserSubscriptionUncheckedUpdateWithoutPaymentsInputObjectSchema = Schema
