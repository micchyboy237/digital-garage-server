...
const Schema: z.ZodType<Prisma.OwnershipUpdateWithoutVehicleDisplayPhotoInput> = z
  .object({
...
export const OwnershipUpdateWithoutVehicleDisplayPhotoInputObjectSchema = Schema
