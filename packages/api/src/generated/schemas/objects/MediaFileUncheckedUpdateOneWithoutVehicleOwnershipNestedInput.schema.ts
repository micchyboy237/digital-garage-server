...
const Schema: z.ZodType<Prisma.MediaFileUncheckedUpdateOneWithoutVehicleOwnershipNestedInput> = z
  .object({
    create: z
      .union([
...
export const MediaFileUncheckedUpdateOneWithoutVehicleOwnershipNestedInputObjectSchema = Schema
