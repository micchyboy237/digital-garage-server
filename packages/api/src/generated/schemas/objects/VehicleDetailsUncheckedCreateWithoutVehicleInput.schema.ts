...
const Schema: z.ZodType<Prisma.VehicleDetailsUncheckedCreateWithoutVehicleInput> = z
  .object({
...
export const VehicleDetailsUncheckedCreateWithoutVehicleInputObjectSchema = Schema
