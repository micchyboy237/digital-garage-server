...
const Schema: z.ZodType<Prisma.OwnershipUpdateManyWithoutVehicleNestedInput> = z
  .object({
    create: z
      .union([
...
export const OwnershipUpdateManyWithoutVehicleNestedInputObjectSchema = Schema
