...
const Schema: z.ZodType<Prisma.VehicleTransferCreateNestedManyWithoutRecipientInput> = z
  .object({
    create: z
      .union([
...
export const VehicleTransferCreateNestedManyWithoutRecipientInputObjectSchema = Schema
