...
const Schema: z.ZodType<Prisma.VehicleEventCreateWithoutVehicleOwnershipInput> = z
  .object({
...
export const VehicleEventCreateWithoutVehicleOwnershipInputObjectSchema = Schema
