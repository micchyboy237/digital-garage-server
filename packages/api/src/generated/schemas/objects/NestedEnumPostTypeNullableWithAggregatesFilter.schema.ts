...
const Schema: z.ZodType<Prisma.NestedEnumPostTypeNullableWithAggregatesFilter> = z
  .object({
    equals: z
      .lazy(() => PostTypeSchema)
      .optional()
...
export const NestedEnumPostTypeNullableWithAggregatesFilterObjectSchema = Schema
