...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutProfilePictureInput> = z
  .object({
...
export const UserUncheckedUpdateWithoutProfilePictureInputObjectSchema = Schema
