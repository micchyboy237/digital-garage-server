...
const Schema: z.ZodType<Prisma.MediaFileUncheckedUpdateManyWithoutVehicleFilesInput> = z
  .object({
...
export const MediaFileUncheckedUpdateManyWithoutVehicleFilesInputObjectSchema = Schema
