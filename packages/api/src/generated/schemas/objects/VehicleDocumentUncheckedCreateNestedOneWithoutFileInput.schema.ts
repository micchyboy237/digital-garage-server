...
const Schema: z.ZodType<Prisma.VehicleDocumentUncheckedCreateNestedOneWithoutFileInput> = z
  .object({
    create: z
      .union([
...
export const VehicleDocumentUncheckedCreateNestedOneWithoutFileInputObjectSchema = Schema
