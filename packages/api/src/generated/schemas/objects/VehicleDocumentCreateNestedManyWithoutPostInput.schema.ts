...
const Schema: z.ZodType<Prisma.VehicleDocumentCreateNestedManyWithoutPostInput> = z
  .object({
    create: z
      .union([
...
export const VehicleDocumentCreateNestedManyWithoutPostInputObjectSchema = Schema
