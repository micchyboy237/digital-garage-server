...
const Schema: z.ZodType<Prisma.PaymentUncheckedUpdateManyInput> = z
  .object({
    ...
    userSubscriptionId: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
    stripePaymentId: z
...
export const PaymentUncheckedUpdateManyInputObjectSchema = Schema
