...
const Schema: z.ZodType<Prisma.UserSubscriptionScalarWhereInput> = z
  .object({
    AND: z
      .union([
      ...
      .optional(),
    OR: z
      .lazy(() => UserSubscriptionScalarWhereInputObjectSchema)
      .array()
      .optional(),
    NOT: z
      .union([
...
export const UserSubscriptionScalarWhereInputObjectSchema = Schema
