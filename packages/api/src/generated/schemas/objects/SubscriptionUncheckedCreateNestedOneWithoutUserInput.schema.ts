...
const Schema: z.ZodType<Prisma.SubscriptionUncheckedCreateNestedOneWithoutUserInput> = z
  .object({
    create: z
      .union([
...
export const SubscriptionUncheckedCreateNestedOneWithoutUserInputObjectSchema = Schema
