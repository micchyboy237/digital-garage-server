...
const Schema: z.ZodType<Prisma.VehicleOwnershipUncheckedCreateNestedOneWithoutVehicleDisplayPhotoInput> = z
  .object({
    create: z
      .union([
...
export const VehicleOwnershipUncheckedCreateNestedOneWithoutVehicleDisplayPhotoInputObjectSchema = Schema
