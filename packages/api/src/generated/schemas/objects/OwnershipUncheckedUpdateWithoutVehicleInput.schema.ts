...
const Schema: z.ZodType<Prisma.OwnershipUncheckedUpdateWithoutVehicleInput> = z
  .object({
...
export const OwnershipUncheckedUpdateWithoutVehicleInputObjectSchema = Schema
