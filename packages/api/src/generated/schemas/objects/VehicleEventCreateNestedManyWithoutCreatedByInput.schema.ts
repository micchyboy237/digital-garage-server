...
const Schema: z.ZodType<Prisma.VehicleEventCreateNestedManyWithoutCreatedByInput> = z
  .object({
    create: z
      .union([
...
export const VehicleEventCreateNestedManyWithoutCreatedByInputObjectSchema = Schema
