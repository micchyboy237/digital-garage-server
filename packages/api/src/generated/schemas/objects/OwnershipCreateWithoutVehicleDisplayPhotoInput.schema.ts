...
const Schema: z.ZodType<Prisma.OwnershipCreateWithoutVehicleDisplayPhotoInput> = z
  .object({
...
export const OwnershipCreateWithoutVehicleDisplayPhotoInputObjectSchema = Schema
