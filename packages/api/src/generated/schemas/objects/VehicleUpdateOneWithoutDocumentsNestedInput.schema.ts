...
const Schema: z.ZodType<Prisma.VehicleUpdateOneWithoutDocumentsNestedInput> = z
  .object({
    create: z
      .union([
...
export const VehicleUpdateOneWithoutDocumentsNestedInputObjectSchema = Schema
