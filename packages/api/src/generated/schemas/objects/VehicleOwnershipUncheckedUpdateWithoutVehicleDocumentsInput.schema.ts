...
const Schema: z.ZodType<Prisma.VehicleOwnershipUncheckedUpdateWithoutVehicleDocumentsInput> = z
  .object({
...
export const VehicleOwnershipUncheckedUpdateWithoutVehicleDocumentsInputObjectSchema = Schema
