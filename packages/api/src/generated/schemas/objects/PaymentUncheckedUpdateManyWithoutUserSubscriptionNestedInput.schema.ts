...
const Schema: z.ZodType<Prisma.PaymentUncheckedUpdateManyWithoutUserSubscriptionNestedInput> = z
  .object({
    create: z
      .union([
...
export const PaymentUncheckedUpdateManyWithoutUserSubscriptionNestedInputObjectSchema = Schema
