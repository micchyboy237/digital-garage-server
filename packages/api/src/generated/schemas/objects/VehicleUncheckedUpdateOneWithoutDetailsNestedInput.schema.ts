...
const Schema: z.ZodType<Prisma.VehicleUncheckedUpdateOneWithoutDetailsNestedInput> = z
  .object({
    create: z
      .union([
...
export const VehicleUncheckedUpdateOneWithoutDetailsNestedInputObjectSchema = Schema
