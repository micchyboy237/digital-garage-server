...
const Schema: z.ZodType<Prisma.UserWhereInput> = z
  .object({
    ...
    auth: z
      ...
      .nullable(),
    session: z
      .union([z.lazy(() => SessionRelationFilterObjectSchema), z.lazy(() => SessionWhereInputObjectSchema)])
      .optional()
      .nullable(),
    subscription: z
      ...
      .optional()
      .nullable(),
    vehicles: z.lazy(() => VehicleOwnershipListRelationFilterObjectSchema).optional(),
