...
const Schema: z.ZodType<Prisma.DocumentUpdateManyWithWhereWithoutVehicleInput> = z
  .object({
...
export const DocumentUpdateManyWithWhereWithoutVehicleInputObjectSchema = Schema
