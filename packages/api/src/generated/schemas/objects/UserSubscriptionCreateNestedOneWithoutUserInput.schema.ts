...
const Schema: z.ZodType<Prisma.UserSubscriptionCreateNestedOneWithoutUserInput> = z
  .object({
    create: z
      .union([
...
export const UserSubscriptionCreateNestedOneWithoutUserInputObjectSchema = Schema
