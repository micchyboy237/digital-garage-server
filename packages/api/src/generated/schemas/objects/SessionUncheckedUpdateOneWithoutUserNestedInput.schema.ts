...
const Schema: z.ZodType<Prisma.SessionUncheckedUpdateOneWithoutUserNestedInput> = z
  .object({
    create: z
      .union([
...
export const SessionUncheckedUpdateOneWithoutUserNestedInputObjectSchema = Schema
