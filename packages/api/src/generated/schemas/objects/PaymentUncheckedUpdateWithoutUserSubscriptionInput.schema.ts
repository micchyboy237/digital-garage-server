...
const Schema: z.ZodType<Prisma.PaymentUncheckedUpdateWithoutUserSubscriptionInput> = z
  .object({
...
export const PaymentUncheckedUpdateWithoutUserSubscriptionInputObjectSchema = Schema
