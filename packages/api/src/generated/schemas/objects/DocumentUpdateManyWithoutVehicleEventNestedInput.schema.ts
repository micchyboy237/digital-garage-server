...
const Schema: z.ZodType<Prisma.DocumentUpdateManyWithoutVehicleEventNestedInput> = z
  .object({
    create: z
      .union([
...
export const DocumentUpdateManyWithoutVehicleEventNestedInputObjectSchema = Schema
