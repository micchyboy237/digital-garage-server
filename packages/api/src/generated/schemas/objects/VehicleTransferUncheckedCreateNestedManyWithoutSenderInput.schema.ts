...
const Schema: z.ZodType<Prisma.VehicleTransferUncheckedCreateNestedManyWithoutSenderInput> = z
  .object({
    create: z
      .union([
...
export const VehicleTransferUncheckedCreateNestedManyWithoutSenderInputObjectSchema = Schema
