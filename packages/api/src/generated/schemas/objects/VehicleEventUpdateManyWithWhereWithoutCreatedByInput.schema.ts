...
const Schema: z.ZodType<Prisma.VehicleEventUpdateManyWithWhereWithoutCreatedByInput> = z
  .object({
...
export const VehicleEventUpdateManyWithWhereWithoutCreatedByInputObjectSchema = Schema
