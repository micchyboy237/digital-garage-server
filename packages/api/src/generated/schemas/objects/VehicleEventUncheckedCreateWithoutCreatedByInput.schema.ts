...
const Schema: z.ZodType<Prisma.VehicleEventUncheckedCreateWithoutCreatedByInput> = z
  .object({
...
export const VehicleEventUncheckedCreateWithoutCreatedByInputObjectSchema = Schema
