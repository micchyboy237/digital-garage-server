...
const Schema: z.ZodType<Prisma.UserUpdateOneWithoutDisplayPictureNestedInput> = z
  .object({
    create: z
      .union([
...
export const UserUpdateOneWithoutDisplayPictureNestedInputObjectSchema = Schema
