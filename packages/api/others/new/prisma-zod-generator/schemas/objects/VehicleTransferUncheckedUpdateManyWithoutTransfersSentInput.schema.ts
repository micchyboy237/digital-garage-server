...
const Schema: z.ZodType<Prisma.VehicleTransferUncheckedUpdateManyWithoutTransfersSentInput> = z
  .object({
...
export const VehicleTransferUncheckedUpdateManyWithoutTransfersSentInputObjectSchema = Schema
