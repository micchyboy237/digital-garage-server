...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutDisplayPictureInput> = z
  .object({
...
export const UserUncheckedCreateWithoutDisplayPictureInputObjectSchema = Schema
