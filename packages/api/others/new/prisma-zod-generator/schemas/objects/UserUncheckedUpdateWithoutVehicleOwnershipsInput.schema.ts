...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutVehicleOwnershipsInput> = z
  .object({
...
export const UserUncheckedUpdateWithoutVehicleOwnershipsInputObjectSchema = Schema
