...
const Schema: z.ZodType<Prisma.MediaFileUncheckedCreateNestedManyWithoutPostInput> = z
  .object({
    create: z
      .union([
...
export const MediaFileUncheckedCreateNestedManyWithoutPostInputObjectSchema = Schema
