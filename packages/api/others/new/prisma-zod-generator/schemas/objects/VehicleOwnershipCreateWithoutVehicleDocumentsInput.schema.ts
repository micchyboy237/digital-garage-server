...
const Schema: z.ZodType<Prisma.VehicleOwnershipCreateWithoutVehicleDocumentsInput> = z
  .object({
...
export const VehicleOwnershipCreateWithoutVehicleDocumentsInputObjectSchema = Schema
