...
import { VehicleOwnershipUpdateOneWithoutVehicleDetailsNestedInputObjectSchema } from "./VehicleOwnershipUpdateOneWithoutVehicleDetailsNestedInput.schema"
...
const Schema: z.ZodType<Prisma.VehicleDetailsUpdateInput> = z
  .object({
    ...
    ownership: z.lazy(() => VehicleOwnershipUpdateOneWithoutVehicleDetailsNestedInputObjectSchema).optional(),
  })
  .strict()
