...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutTransfersReceivedInput> = z
  .object({
...
export const UserUncheckedUpdateWithoutTransfersReceivedInputObjectSchema = Schema
