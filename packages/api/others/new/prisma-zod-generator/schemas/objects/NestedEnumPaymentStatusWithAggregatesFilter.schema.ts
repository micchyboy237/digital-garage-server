...
const Schema: z.ZodType<Prisma.NestedEnumPaymentStatusWithAggregatesFilter> = z
  .object({
...
export const NestedEnumPaymentStatusWithAggregatesFilterObjectSchema = Schema
