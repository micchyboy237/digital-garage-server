...
const Schema: z.ZodType<Prisma.MediaFileCreateNestedManyWithoutOwnershipInput> = z
  .object({
    create: z
      .union([
...
export const MediaFileCreateNestedManyWithoutOwnershipInputObjectSchema = Schema
