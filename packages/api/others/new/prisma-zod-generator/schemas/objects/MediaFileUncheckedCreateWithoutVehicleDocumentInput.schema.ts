...
const Schema: z.ZodType<Prisma.MediaFileUncheckedCreateWithoutVehicleDocumentInput> = z
  .object({
...
export const MediaFileUncheckedCreateWithoutVehicleDocumentInputObjectSchema = Schema
