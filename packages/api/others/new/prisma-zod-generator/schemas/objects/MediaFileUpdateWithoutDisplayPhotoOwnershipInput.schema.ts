...
const Schema: z.ZodType<Prisma.MediaFileUpdateWithoutDisplayPhotoOwnershipInput> = z
  .object({
...
export const MediaFileUpdateWithoutDisplayPhotoOwnershipInputObjectSchema = Schema
