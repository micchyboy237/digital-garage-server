...
const Schema: z.ZodType<Prisma.VehicleOwnershipUncheckedCreateWithoutVehiclePhotosInput> = z
  .object({
...
export const VehicleOwnershipUncheckedCreateWithoutVehiclePhotosInputObjectSchema = Schema
