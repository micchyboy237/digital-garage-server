...
const Schema: z.ZodType<Prisma.NestedEnumAccountStatusWithAggregatesFilter> = z
  .object({
...
export const NestedEnumAccountStatusWithAggregatesFilterObjectSchema = Schema
