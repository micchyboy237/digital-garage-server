...
const Schema: z.ZodType<Prisma.MediaFileUncheckedCreateWithoutOwnershipInput> = z
  .object({
...
export const MediaFileUncheckedCreateWithoutOwnershipInputObjectSchema = Schema
