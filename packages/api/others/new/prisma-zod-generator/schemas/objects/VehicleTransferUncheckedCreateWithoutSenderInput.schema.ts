...
const Schema: z.ZodType<Prisma.VehicleTransferUncheckedCreateWithoutSenderInput> = z
  .object({
...
export const VehicleTransferUncheckedCreateWithoutSenderInputObjectSchema = Schema
