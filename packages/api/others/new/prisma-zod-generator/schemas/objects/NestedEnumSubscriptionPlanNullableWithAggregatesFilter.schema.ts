...
const Schema: z.ZodType<Prisma.NestedEnumSubscriptionPlanNullableWithAggregatesFilter> = z
  .object({
    equals: z
...
export const NestedEnumSubscriptionPlanNullableWithAggregatesFilterObjectSchema = Schema
