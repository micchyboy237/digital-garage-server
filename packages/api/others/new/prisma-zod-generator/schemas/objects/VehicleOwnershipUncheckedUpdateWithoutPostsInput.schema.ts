...
const Schema: z.ZodType<Prisma.VehicleOwnershipUncheckedUpdateWithoutPostsInput> = z
  .object({
...
export const VehicleOwnershipUncheckedUpdateWithoutPostsInputObjectSchema = Schema
