...
const Schema: z.ZodType<Prisma.VehiclePostUncheckedCreateNestedManyWithoutCreatedByInput> = z
  .object({
    create: z
      .union([
...
export const VehiclePostUncheckedCreateNestedManyWithoutCreatedByInputObjectSchema = Schema
