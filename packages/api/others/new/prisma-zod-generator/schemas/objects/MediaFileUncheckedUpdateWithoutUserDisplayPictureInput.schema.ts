...
const Schema: z.ZodType<Prisma.MediaFileUncheckedUpdateWithoutUserDisplayPictureInput> = z
  .object({
...
export const MediaFileUncheckedUpdateWithoutUserDisplayPictureInputObjectSchema = Schema
