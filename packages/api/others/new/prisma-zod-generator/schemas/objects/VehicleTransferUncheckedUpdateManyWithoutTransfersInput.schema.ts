...
const Schema: z.ZodType<Prisma.VehicleTransferUncheckedUpdateManyWithoutTransfersInput> = z
  .object({
...
export const VehicleTransferUncheckedUpdateManyWithoutTransfersInputObjectSchema = Schema
