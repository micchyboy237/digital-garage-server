...
const Schema: z.ZodType<Prisma.VehicleTransferUncheckedUpdateWithoutSenderInput> = z
  .object({
...
export const VehicleTransferUncheckedUpdateWithoutSenderInputObjectSchema = Schema
