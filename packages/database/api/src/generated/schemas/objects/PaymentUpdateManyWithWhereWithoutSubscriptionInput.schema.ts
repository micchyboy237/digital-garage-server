...
const Schema: z.ZodType<Prisma.PaymentUpdateManyWithWhereWithoutSubscriptionInput> = z
  .object({
...
export const PaymentUpdateManyWithWhereWithoutSubscriptionInputObjectSchema = Schema
