...
import { UserUpdateOneWithoutSubscriptionNestedInputObjectSchema } from "./UserUpdateOneWithoutSubscriptionNestedInput.schema"
import { PaymentUpdateManyWithoutSubscriptionNestedInputObjectSchema } from "./PaymentUpdateManyWithoutSubscriptionNestedInput.schema"
...
const Schema: z.ZodType<Prisma.SubscriptionUpdateInput> = z
  .object({
    ...
    endDate: z
      ...
      .optional()
      .nullable(),
    user: z.lazy(() => UserUpdateOneWithoutSubscriptionNestedInputObjectSchema).optional(),
    payments: z.lazy(() => PaymentUpdateManyWithoutSubscriptionNestedInputObjectSchema).optional(),
  })
  .strict()
