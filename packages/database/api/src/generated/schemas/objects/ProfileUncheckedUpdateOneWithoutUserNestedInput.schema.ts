...
const Schema: z.ZodType<Prisma.ProfileUncheckedUpdateOneWithoutUserNestedInput> = z
  .object({
    create: z
      .union([
...
export const ProfileUncheckedUpdateOneWithoutUserNestedInputObjectSchema = Schema
