...
const Schema: z.ZodType<Prisma.PaymentUncheckedCreateNestedManyWithoutSubscriptionInput> = z
  .object({
    create: z
      .union([
...
export const PaymentUncheckedCreateNestedManyWithoutSubscriptionInputObjectSchema = Schema
