...
-- CreateEnum
CREATE TYPE "EventType" AS ENUM ('post', 'reminder', 'invoice', 'document');

-- CreateEnum
CREATE TYPE "DocumentType" AS ENUM ('general', 'photo');
...
-- AddForeignKey
ALTER TABLE "VehicleEvent" ADD CONSTRAINT "VehicleEvent_vehicleId_fkey" FOREIGN KEY ("vehicleId") REFERENCES "Vehicle"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VehicleEvent" ADD CONSTRAINT "VehicleEvent_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VehicleEvent" ADD CONSTRAINT "VehicleEvent_vehicleOwnershipId_fkey" FOREIGN KEY ("vehicleOwnershipId") REFERENCES "VehicleOwnership"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Document" ADD CONSTRAINT "Document_vehicleEventId_fkey" FOREIGN KEY ("vehicleEventId") REFERENCES "VehicleEvent"("id") ON DELETE SET NULL ON UPDATE CASCADE;
