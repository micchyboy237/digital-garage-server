...
-- CreateIndex
CREATE UNIQUE INDEX "User_displayPictureId_key" ON "User"("displayPictureId");
...
-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "User_displayPictureId_fkey" FOREIGN KEY ("displayPictureId") REFERENCES "MediaFile"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "VehicleOwnership" ADD CONSTRAINT "VehicleOwnership_vehicleDisplayPhotoId_fkey" FOREIGN KEY ("vehicleDisplayPhotoId") REFERENCES "MediaFile"("id") ON DELETE CASCADE ON UPDATE CASCADE;
